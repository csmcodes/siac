<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfCobroxSocio.aspx.cs" Inherits="WebUI.wfCobroxSocio" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/CobroxSocio.js"></script>
     ...
     <div class="maincontent">
            <div class="maincontentinner">                                              
               <div id="area">
                    ...
                    <h4>REPORTE COBRO POR SOCIO</h4>
                    <br />
                     <div id="comcabecera">     
                                                                                                 
                    </div>                          
                    <iframe id="ireport" src="" style="width:100%;height:800px";>
                    </iframe>                                           
                </div>
