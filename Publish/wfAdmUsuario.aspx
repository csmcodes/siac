<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfAdmUsuario.aspx.cs" Inherits="WebUI.wfAdmUsuario" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/AdmUsuario.js"></script>
                 ...
                 <div id="Div1" >   
                             <div id="Div2">
                                <ul class="list-nostyle list-inline">
                                   ...
                                   <li><div class="btn" id="addnew"><i class="iconfa-plus"></i> &nbsp; Agregar</div></li>
