    ...
    <form id="form1" runat="server">
     ...
     <div class="maincontent">
       ...
       <p class='stdformbutton'><button id='btnfixcomprobantes' class='btn btn-primary'>Fix comprobantes</button></p>       
         ...
         <p class='stdformbutton'>
             <input type="text" id="txtdesde" placeholder="desde"/>
             <input type="text" id="txthasta" placeholder="hasta"/>
             <input type="text" id="txtpersona" placeholder="cod persona"/>
             <input type="text" id="txtcomp" placeholder="cod comp"/>
             <button id='btncuadreconanx' class='btn btn-primary'>Cuadrar Contables Anexos</button>
