<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfPlanillaClienteCOMY.aspx.cs" Inherits="WebUI.wfPlanillaClienteCOMY" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/PlanillaClienteCOMY.js"></script>
