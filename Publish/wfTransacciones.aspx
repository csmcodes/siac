<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfTransacciones.aspx.cs" Inherits="WebUI.wfTransacciones" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Transacciones.js"></script>
     ...
     <div class="maincontent">
            <div class="maincontentinner">
                ...
                <div id="busqueda" class="widgetbox">
                    ...
                    <div id="listado2"  class="widgetbox">      
                         <div class="headtitle">
                            <div class="btn-group">
                                <button data-toggle="dropdown" class="btn dropdown-toggle">Opciones <span class="caret"></span></button>
                                <ul class="dropdown-menu">
                                  <li><a id ="asclist" href="#">Ordenar ascendentemente</a></li>
                                  <li><a id ="deslist" href="#">Ordenar descendentemente</a></li>                                  
                                  <li class="divider"></li>                                  
                                  <li><a id ="closelist" href="#">Cerrar listado</a></li>
                                </ul>
                            </div>
                            <h4 class="widgettitle"><span class="icon-th-list icon-white"></span>Listado&nbsp;</h4>
                        </div>         
                        <div class="widgetcontent">                                       
                            <ul id ="listadocontent" class="userlist"">                                                     
                            </ul>                               
                        </div>       
                </div>
