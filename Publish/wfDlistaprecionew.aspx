<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDlistaprecionew.aspx.cs" Inherits="WebUI.wfDlistaprecionew" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Dlistaprecionew.js"></script>
...
<body>
      ...
      <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-tags"></span></div>
            <div class="pagetitle">
                <h5>Detalle de lista de Precios</h5>
                <h1>Detalle Lista Precio</h1>
            </div>
        </div><!--pageheader-->
