<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDtipodoc.aspx.cs" Inherits="WebUI.wfDtipodoc" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Dtipodoc.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de detalle tipo de documento</h5>
                <h1>Detalle tipo de documento</h1>
            </div>
        </div><!--pageheader-->
