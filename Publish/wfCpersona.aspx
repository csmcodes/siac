<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfCpersona.aspx.cs" Inherits="WebUI.wfCpersona" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Cpersona.js"></script>    
    ...
    <form id="form1" runat="server">
     <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-tasks"></span></div>
            <div class="pagetitle">
                <h5>Gestión de Categorias de Persona</h5>
                <h1>Categorias de Persona</h1>
            </div>
        </div><!--pageheader-->
