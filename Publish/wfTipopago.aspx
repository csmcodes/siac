<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfTipopago.aspx.cs" Inherits="WebUI.wfTipopago" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Tipopago.js"></script>
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-briefcase"></span></div>
            <div class="pagetitle">
                <h5>Listado de Tipos de Pago</h5>
                <h1>TIpos de Pago</h1>
            </div>
        </div><!--pageheader-->
