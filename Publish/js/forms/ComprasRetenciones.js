...
var formname = "wfComprasRetenciones.aspx";
var menuoption = "ComprasRetenciones";
...
function LoadReporte() {
    ...
    var conRet = GetCheckValue($("#txtConRetenciones"));
    var sinRet = GetCheckValue($("#txtSinRetenciones")); 
   
    var usr = usuariosigned["usr_id"];

    var url = "./reports/wfReportPrint.aspx?report=COMPRET&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=" + conRet + "&parameter9=" + sinRet;
