...
var formname = "wfReporteVentasSocioTipo.aspx";
var menuoption = "VentasSocioTipo";
...
function LoadReporte() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=VENSOTIPODET&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa;
...
function LoadReporteTotales() {
    ...
    var strpventa = $("#cmbPVENTA option:selected").text();
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=VENSOTIPO&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes,scrolling=0,scrollbars=0";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}

function LoadReporteTotalesCho()
{
    var desde = $("#txtDESDE").val(); //.datepicker("getDate");
    var hasta = $("#txtHASTA").val(); //.datepicker("getDate");
    var socio = $("#cmbUSUARIO").val();
    ...
    var strpventa = $("#cmbPVENTA option:selected").text();
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=VENSOCHOTIPO&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes,scrolling=0,scrollbars=0";
    window.open(url, "Reporte", feautures);
}
