...
var formname = "wfReporteHojaRutaCab.aspx";
var menuoption = "ReporteHojaRutaCab";
...
function LoadReporteDet() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=HOJARUTACAB&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa + "&parameter9=" + ruta + "&parameter10=" + strruta;
...
function LoadReporteCon() {
    ...
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=HOJARUTACABCON&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa + "&parameter9=" + ruta + "&parameter10=" + strruta;
