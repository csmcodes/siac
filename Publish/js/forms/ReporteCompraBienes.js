...
var formname = "wfReporteCompraBienes.aspx";
var menuoption = "ReporteCompraBienes";
...
function LoadReporte(tipo) {
    ...
    var url = "";
    if (tipo == 0)
        url = "./reports/wfReportPrint.aspx?report=VENCB&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr;
    if (tipo == 1)
        url = "./reports/wfReportPrint.aspx?report=COMPRET&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=true";        
    if (tipo == 2)
        url = "./reports/wfReportPrint.aspx?report=COMPRET&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=false";        
