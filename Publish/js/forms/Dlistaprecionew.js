...
var formname = "wfDlistaprecionew.aspx";
var menuoption = "Dlistaprecionew";
...
function GetDlistaPrecioObj() {
    ...
    obj["dlpr_nombreruta"] = $("#cmbRUTA_P option:selected").text();
    obj["dlpr_nombrelistaprecio"] = $("#cmbLISTA_P option:selected").text();
