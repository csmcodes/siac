...
var formname = "wfReporteVentasSocio.aspx";
...
function LoadReporte() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=VENSO&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa;
...
function LoadReporteSaldos() {
    ...
    var strpventa = $("#cmbPVENTA option:selected").text();
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=VENSOSALDO&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes,scrolling=yes,scrollbars=yes";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}
...
function LoadReporteVehiculo() {
    ...
    var strpventa = $("#cmbPVENTA option:selected").text();
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=VENSOVEH&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes,scrolling=yes,scrollbars=yes";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}
