...
var formname = "wfHojaRuta.aspx";
var menuoption = "HojaRuta";
...
function PrintObj() {
    ...
    window.open("wfHojaRutaPrint.aspx?empresa=" + empresa + "&usuario=" + idusuario + "&codigocomp=" + $("#txtcodigocomp").val(), "ImpHR", opciones);


    //var opciones = "toolbar=no, scrollbars=no, resizable=yes, top=50, left=100, width=800, height=600";
    //window.open("wfHojaRutaPrint.aspx?codigocomp=" + $("#txtcodigocomp").val(), "Imp", opciones);
...
function GetCSV() {
    var empresa = parseInt(empresasigned["emp_codigo"]);    
    var opciones = "toolbar=no, scrollbars=no, resizable=yes, top=50, left=100, width=800, height=600";
    window.open("wfHojaRutaTxt.aspx?empresa=" + empresa + "&codigo=" + $("#txtcodigocomp").val(), "TxtHR", opciones);
}
