...
var formname = "wfReportePlanillaSocioTot.aspx";
var menuoption = "wfReportePlanillaSocioTot";
...
function LoadReporte(tipo) {
    ...
    var socio = $("#txtPERSONA").val(); //.datepicker("getDate");
    var report = "";
    if (tipo == 1)
        report = "PLANILLASOCTOT";
    if (tipo == 2)
        report = "PLANILLASOCTOTCON";
    ...
    var url = "./reports/wfReportPrint.aspx?report="+report+"&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio +  "&parameter4=" + usr;
