...
var formname = "wfDtipodoc.aspx";
var menuoption = "Dtipodoc";
...
function LoadDetalle() {
    var obj = {};
    obj["dtp_tipodoc"] = $("#cmbTIPODOC_S").val();
    obj["dtp_empresa"] = parseInt(empresasigned["emp_codigo"]); 
...
function GetJSONObject() {
    var obj = {};
    obj["dtp_tipodoc"] = $("#cmbTIPODOC_S").val();
    obj["dtp_tipodoc_key"] = $("#txtTIPODOC_key").val();
    obj["dtp_empresa"] =parseInt(empresasigned["emp_codigo"]);
    obj["dtp_empresa_key"] =parseInt(empresasigned["emp_codigo"]);
    obj["dtp_ctipocom"] = $("#cmbCTIPOCOM").val();
    obj["dtp_ctipocom_key"] = $("#cmbCTIPOCOM").val();
    obj["dtp_idctipocom"] = $("#cmbCTIPOCOM option:selected").text();
    obj["dtp_estado"] = GetCheckValue($("#chkESTADO"));
...
function SetJSONObject(obj) {
    ...
    $("#cmbTIPODOC_S").val(obj["dtp_tipodoc"]);
    $("#txtTIPODOC_key").val(obj["dtp_tipodoc_key"]);
   
    $("#cmbCTIPOCOM").val(obj["dtp_ctipocom"]);   
   
    $("#chkESTADO").prop("checked", SetCheckValue(obj["dtp_estado"]));
