...
$(document).ready(function () {
    ...
    $("#btncuadreconanx").on("click", CuadrarContablesAnexos);
...
function CuadrarContablesAnexos() {
    var obj = {};
    obj["desde"] = $("#txtdesde").val();
    obj["hasta"] = $("#txthasta").val();
    obj["persona"] = $("#txtpersona").val();
    obj["codigo"] = $("#txtcomp").val();
    var jsonText = JSON.stringify({ objeto: obj });
    CallServerMethods(webservice + "CuadrarContablesAnexos", jsonText, 2);
}