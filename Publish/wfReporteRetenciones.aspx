<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfReporteRetenciones.aspx.cs" Inherits="WebUI.wfReporteRetenciones" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/ReporteRetenciones.js"></script>
...
<body>
    ...
    <div class = "maincontentinner">
     ...
     <div id="area">
                    ...
                    <h4>REPORTE DE RETENCIONES POR CONCEPTO</h4>
                    <br />
                     <div id="comcabecera">     
