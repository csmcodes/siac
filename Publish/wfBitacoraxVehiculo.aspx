<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfBitacoraxVehiculo.aspx.cs" Inherits="WebUI.wfBitacoraxVehiculo" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/BitacoraxVehiculo.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de Bitacoras de Vehiculos</h5>
                <h1>Bitacoras de Vehiculos</h1>
            </div>
        </div><!--pageheader-->
