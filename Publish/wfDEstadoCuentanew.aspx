<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDEstadoCuentanew.aspx.cs" Inherits="WebUI.wfDEstadoCuentanew" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/DEstadocuentanew.js"></script>
...
<body>
      <form id="form1" runat="server">
            ...
            <div class="searchbar">               
                <div id="barra">                    
                    <ul class="list-nostyle list-inline">
                        <li><div class="btn" id="Div1" href="#myModal" data-toggle="modal"><i class="iconsweets-info"></i> &nbsp; Ayuda</div></li>                                                
                    </ul>
           ...
           <div class="pageicon"><span class="iconfa-tags"></span></div>
            <div class="pagetitle">
                <h5>Detalle de Estado de Cuenta de cada Persona</h5>
            ...
            <div class="maincontentinner">                                              
               <div id="area">
                    ...
                    <asp:TextBox ID="txtdebcre" runat="server"></asp:TextBox>          
                              <asp:TextBox ID="txtnombreplm" runat="server"></asp:TextBox>             
                                    </div>              

                     <div id="comcabecera">     
                         <ul class="list-nostyle list-inline">
                        
                        <li><div class="btn" id="printcartera"><i class="iconfa-print"></i>&nbsp; Cartera</div></li>
                        <li><div class="btn" id="printestado"><i class="iconfa-print"></i>&nbsp;  Estado Cuenta </div></li>
