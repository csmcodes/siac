<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WfreporteDescuadres.aspx.cs" Inherits="WebUI.WfreporteDescuadradosaspx" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/ReporteDescuadres.js"></script>
</head>
<body>
     ...
     <div class="maincontent">
            <div class="maincontentinner">                                              
               <div id="area">
                    ...
                    <h4>REPORTE COMPROBANTES DESCUADRADOS</h4>
                    <br />
                     <div id="comcabecera">     
