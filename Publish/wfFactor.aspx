<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfFactor.aspx.cs" Inherits="WebUI.wfFactor" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Factor.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de Factores</h5>
                <h1>Detalle Factores de Producto</h1>
            </div>
        </div><!--pageheader-->
