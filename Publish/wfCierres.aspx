<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfCierres.aspx.cs" Inherits="WebUI.wfCierres" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Cierres.js"></script>
     ...
     <div class="maincontent">
            <div class="maincontentinner">                                              
               <div id="area">
                    ...
                    <h4>CIERRE AUTOMÁTICO DE CUENTAS</h4>
                    <br />
                     <div id="comcabecera">     
