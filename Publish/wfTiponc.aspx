<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfTiponc.aspx.cs" Inherits="WebUI.wfTiponc" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Tiponc.js"></script>
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-user"></span></div>
            <div class="pagetitle">
                <h5>Listado de Tipo Notas de Credito/Debito</h5>
                <h1>Tipo Notas de Credito/Debito</h1>
            </div>
        </div><!--pageheader-->
