<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfTproducto.aspx.cs" Inherits="WebUI.wfTproducto" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Tproducto.js"></script>    
    ...
    <form id="form1" runat="server">
     <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-tasks"></span></div>
            <div class="pagetitle">
                <h5>Gestión de Tipos de Productos</h5>
