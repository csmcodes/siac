...
{
   public  class vHojaRutaReporteDAL
    {
        #region Get All

        public static List<vHojaRutaReporte> GetAll(WhereParams parametros, string OrderBy)
        {
            List<vHojaRutaReporte> list = new List<vHojaRutaReporte>();
            vHojaRutaReporte obj = new vHojaRutaReporte();
            if (DAL.GetProvider() == Provider.SqlServer)
            {
                ...
                try
                {
                    ...
                    do
                    {
                        if (!reader.Read())
                            break; // we are done
                        list.Add(new vHojaRutaReporte(reader));
