...
{
    public class vComprobanteHojaRutaDAL
    {
        #region Get All

        public static List<vComprobanteHojaRuta> GetAll(WhereParams parametros, string OrderBy)
        {
            List<vComprobanteHojaRuta> list = new List<vComprobanteHojaRuta>();
            vComprobanteHojaRuta obj = new vComprobanteHojaRuta();
            if (DAL.GetProvider() == Provider.SqlServer)
            {
                ...
                try
                {
                    ...
                    do
                    {
                        if (!reader.Read())
                            break; // we are done
                        list.Add(new vComprobanteHojaRuta(reader));
