<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfComprobante.aspx.cs" Inherits="WebUI.wfComprobante" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/popup.js?10"></script>
    ...
    <script type="text/javascript" src="js/forms/Comprobante.js?v=20260902"></script>
