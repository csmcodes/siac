...
namespace WebUI
{
    public partial class wfReporteTpagos : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
           ...
           tdatos.rows[2].cells[0].valor = "Tipo Pago";
           tdatos.rows[2].cells[1].valor = new Select { id = "cmbTipoPago", clase = Css.large, diccionario = Dictionaries.GetTipoPago(), withempty = true }.ToString();
            ...
            tdatos.rows[5].cells[1].valor = new Boton { click = "LoadReporte();return false;", valor = "Generar" }.ToString();
