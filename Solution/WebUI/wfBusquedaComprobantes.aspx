<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfBusquedaComprobantes.aspx.cs" Inherits="WebUI.wfBusquedaComprobantes" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/BusquedaComprobantes.js"></script>
...
<body>
      ...
      <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-tags"></span></div>
            <div class="pagetitle">
                <h5>Monitoreo Comprobantes</h5>
                <h1>Monitoreo Comprobantes</h1>
            </div>
        </div><!--pageheader-->
