<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfHojaRutaCT.aspx.cs" Inherits="WebUI.wfHojaRutaCT" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/HojaRutaCT.js"></script>
                    ...
                    <div id="comdetalle" >   
                             <div id="barracomp">
                                <ul class="list-nostyle list-inline">                                    
                                    ...
                                    <li><div class="btn" id="actdet"><i class="iconfa-refresh"></i> &nbsp; Actualizar</div></li>
