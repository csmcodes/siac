...
namespace WebUI
{
    public partial class wfReporteGuiasFacturas : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[6].cells[0].valor = "Socio:";
            tdatos.rows[6].cells[1].valor = new Select { id = "cmbSOCIO", clase = Css.large, diccionario = Dictionaries.GetSocios(), withempty = true }.ToString();
            tdatos.rows[7].cells[0].valor = "Tipo Comprobante:";
            tdatos.rows[7].cells[1].valor = new Select { id = "cmbTIPO", clase = Css.large, diccionario = Dictionaries.GetGuiaFactura(), withempty = false }.ToString();
            tdatos.rows[8].cells[0].valor = "";
            tdatos.rows[8].cells[1].valor = new Boton { click = "LoadReporte();return false;", valor = "Generar Reporte" }.ToString();
