...
namespace WebUI
{
    public partial class wfReporteRetenciones : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[2].cells[1].valor = new Boton { click = "LoadReporte();return false;", valor = "Generar" }.ToString();
