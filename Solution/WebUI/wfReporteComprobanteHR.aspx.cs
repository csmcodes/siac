...
namespace WebUI
{
    public partial class wfReporteComprobanteHR : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[4].cells[1].valor = new Boton { click = "LoadReporte();return false;", valor = "Generar Reporte" }.ToString();
