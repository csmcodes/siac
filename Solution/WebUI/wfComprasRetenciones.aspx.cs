...
namespace WebUI
{
    public partial class wfComprasRetenciones : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[2].cells[0].valor = "Con Retenciones";
            tdatos.rows[2].cells[1].valor = new Check { id = "txtConRetenciones" }.ToString();
            tdatos.rows[3].cells[0].valor = "Sin Retenciones";
            tdatos.rows[3].cells[1].valor = new Check { id = "txtSinRetenciones" }.ToString();
            tdatos.rows[4].cells[0].valor = ":";
            tdatos.rows[4].cells[1].valor = new Boton { click = "LoadReporte();return false;", valor = "Generar" }.ToString();
