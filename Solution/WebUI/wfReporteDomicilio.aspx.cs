...
namespace WebUI
{
    public partial class wfReporteDomicilio : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[4].cells[1].valor = new Select { id = "cmbRUTA", clase = Css.medium, withempty = true, diccionario = Dictionaries.GetRuta() }.ToString();
            tdatos.rows[5].cells[0].valor = "Tipo:";
            tdatos.rows[5].cells[1].valor = new Select { id = "cmbTIPODOC", clase = Css.large, diccionario=Dictionaries.GetTiposFacGui(),withempty=true }.ToString();            
