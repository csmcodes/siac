<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfReporteTpagos.aspx.cs" Inherits="WebUI.wfReporteTpagos" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/ReporteTpagos.js"></script>
</head>
<body>
    ...
    <div class = "maincontentinner">
     ...
     <div id="area">
                    ...
                    <h4>REPORTE DE TIPOS DE PAGO</h4>
                    <br />
                     <div id="comcabecera">     
