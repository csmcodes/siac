...
namespace WebUI
{
    public partial class wfHojaRutaCT : System.Web.UI.Page
    {
        ...
        public static string GetCabecera(object objeto)
        {
            ...
            if (comprobante.com_vehiculo.HasValue)
            {
                socio.per_codigo = vehiculo.veh_duenio ?? 0;
                socio.per_codigo_key = vehiculo.veh_duenio ?? 0;
            ...
            if (comprobante.com_vehiculo.HasValue)
            {
                chofer.per_codigo = vehiculo.veh_chofer1??0;
                chofer.per_codigo_key = vehiculo.veh_chofer1??0;
            ...
            if (comprobante.com_vehiculo.HasValue)
            {
                chofer2.per_codigo = vehiculo.veh_chofer2??0;
                chofer2.per_codigo_key = vehiculo.veh_chofer2??0;
            ...
            tddes.rows[2].cells[1].valor = new Textarea() { id = "txtCONCEPTO", placeholder = "OBSERVACIÓN", clase = Css.blocklevel, valor=comprobante.com_concepto }.ToString();
