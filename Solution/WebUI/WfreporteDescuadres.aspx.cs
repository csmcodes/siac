...
namespace WebUI
{
    public partial class WfreporteDescuadradosaspx : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[2].cells[1].valor = new Input { id = "txtPERIODO", placeholder = "PERIODO", clase = Css.small }.ToString();
            tdatos.rows[3].cells[0].valor = "Mes:";
            tdatos.rows[3].cells[1].valor = new Input { id = "txtMES", placeholder = "MES", clase = Css.small }.ToString();
            tdatos.rows[4].cells[0].valor = "Tipo Documento:";
            tdatos.rows[4].cells[1].valor = new Select { id = "cmbTIPODOC", clase = Css.large, diccionario = Dictionaries.GetTipodoc(), withempty = true }.ToString();
            tdatos.rows[5].cells[0].valor = ":";
            tdatos.rows[5].cells[1].valor = new Boton { click = "LoadReporteFac();return false;", valor = "Facturas" }.ToString();
            tdatos.rows[6].cells[0].valor = ":";
            tdatos.rows[6].cells[1].valor = new Boton { click = "LoadReporteCon();return false;", valor = "Contables" }.ToString();
