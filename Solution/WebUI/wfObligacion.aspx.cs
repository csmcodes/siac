...
namespace WebUI
{
    public partial class wfObligacion : System.Web.UI.Page
    {
        ...
        public static string SaveObject(object objeto)
        {
            ...
            List<vObligacion> list = vObligacionBLL.GetAll(new WhereParams("cdoc_aut_factura={0} and cdoc_acl_retdato={5} and com_estado ={1} and (com_tipodoc ={2} or com_tipodoc= {3}) and com_codclipro={4}",obj.ccomdoc.cdoc_aut_factura,Constantes.cEstadoMayorizado,14,26,obj.com_codclipro, obj.ccomdoc.cdoc_acl_retdato), "");
