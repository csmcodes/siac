<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfPuntoVenta.aspx.cs" Inherits="WebUI.wfPuntoVenta" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/PuntoVenta.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de Puntos de Venta</h5>
                <h1>Bitacoras de Puntos de Venta</h1>
            </div>
        </div><!--pageheader-->
