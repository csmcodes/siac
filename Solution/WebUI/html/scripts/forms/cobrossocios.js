...
function GetForm(codigo) {

    var obj = JsonObj();
   
    CallServerMethods(webservice + "GetFormCobrosSocios", JsonObjString(obj), "Form");
}
...
function GetData() {
    ...
    obj["agrupado"] = $("#cmbagrupado_f").val();
    
    CallServerMethods(webservice + "GetDataCobrosSocios", JsonObjString(obj), "Data");
