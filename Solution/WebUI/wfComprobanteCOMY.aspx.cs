...
namespace WebUI
{
    public partial class wfComprobanteCOMY : System.Web.UI.Page
    {
        ...
        public static string ShowObject(Comprobante obj)
        {
            ...
            tdatos.rows[1].cells[1].valor = new Input { id = "txtRUC", clase = Css.medium, habilitado = false, valor = persona.per_ciruc, obligatorio = true }.ToString() + " " + new Input { id = "txtRAZON", clase = Css.large, habilitado = false, valor = persona.per_razon, obligatorio = true }.ToString();
            tdatos.rows[2].cells[0].valor = "Teléfono/Dirección:";
            tdatos.rows[2].cells[1].valor = new Input { id = "txtTELEFONO", clase = Css.medium, habilitado = false, valor = persona.per_telefono, obligatorio = false }.ToString() + " " + new Input { id = "txtDIRECCION", clase = Css.large, habilitado = false, valor = persona.per_direccion, obligatorio = false }.ToString();
            tdatos.rows[3].cells[0].valor = "Email:";
            tdatos.rows[3].cells[1].valor = new Input { id = "txtMAIL", clase = Css.xlarge, habilitado = false, valor = persona.per_mail }.ToString();
            ...
            tddes.rows[0].cells[1].valor = new Input { id = "txtIDDES", clase = Css.medium, placeholder = "Destinatario", visible = false }.ToString() + " " + new Input { id = "txtNOMBRESDES", autocomplete = "GetPersonaObj", clase = Css.large, obligatorio = true, valor = obj.ccomenv.cenv_nombres_des, habilitado = habilitado }.ToString() + new Input { id = "txtCODDES", visible = false, valor = obj.ccomenv.cenv_destinatario }.ToString() + new Input { id = "txtCIRUCDES", visible = false, valor = obj.ccomenv.cenv_ciruc_des }.ToString() + new Boton { small = true, id = "btncalldes", tooltip = "Agregar Destinatario", clase = "iconsweets-user", click = "CallPersona(this.id," + Constantes.cCliente + ")" }.ToString() + new Boton { small = true, id = "btncleandes", tooltip = "Limpiar datos persona", clase = "iconsweets-refresh", click = "CleanPersona(this.id)" }.ToString();
            tddes.rows[1].cells[0].valor = "Teléfono/Dirección:";
            tddes.rows[1].cells[1].valor = new Input { id = "txtTELEFONODES", clase = Css.medium, habilitado = habilitado, valor = obj.ccomenv.cenv_telefono_des }.ToString() + " " + new Input { id = "txtDIRECCIONDES", clase = Css.large, habilitado = habilitado, valor = obj.ccomenv.cenv_direccion_des, autocomplete = "GetDestinoObj" }.ToString() + (habilitado ? new Boton { small = true, id = "btnadddes", tooltip = "Agregar Destino Destinatario", clase = "iconsweets-home", click = "AddDestino()" }.ToString() + new Boton { small = true, id = "btndeldes", tooltip = "Eliminar Destino Destinatario", clase = "iconsweets-trashcan", click = "DelDestino()" }.ToString() : "");
            tddes.rows[2].cells[0].valor = "Destino/Entregar en:";
            tddes.rows[2].cells[1].valor = new Select { id = "cmbRUTA", clase = Css.medium, diccionario = Dictionaries.GetRutaByAlmacen(obj.com_empresa, obj.com_almacen.Value), valor = obj.ccomenv.cenv_ruta, habilitado = habilitado }.ToString() + ((habilitado) ? new Boton { small = true, id = "btnallruta", tooltip = "Todas las rutas", clase = "iconsweets-refresh", click = "GetAllRutas()" }.ToString() : "") + " " + new Input { id = "txtENTREGADES", clase = Css.large, valor = obj.ccomenv.cenv_observacion, habilitado = habilitado }.ToString();
            //tddes.rows[2].cells[1].valor = new Select { id = "cmbRUTA", clase = Css.medium, diccionario = Dictionaries.GetRutaByAlmacen(obj.com_empresa, obj.com_almacen.Value), valor = obj.ccomenv.cenv_ruta, habilitado = habilitado }.ToString() + ((habilitado) ? new Boton { small = true, id = "btnallruta", tooltip = "Todas las rutas", clase = "iconsweets-refresh", click = "GetAllRutas()" }.ToString() : "") + " " + new Input { id = "txtENTREGADES", clase = Css.large, valor = obj.ccomenv.cenv_observacion, habilitado = habilitado, autocomplete = "GetDestinoObj" }.ToString()+ new Boton { small = true, id = "btnadddes", tooltip = "Agregar Destino Destinatario", clase = "iconsweets-home", click = "AddDestino()" }.ToString()+ new Boton { small = true, id = "btndeldes", tooltip = "Eliminar Destino Destinatario", clase = "iconsweets-trashcan", click = "DelDestino()" }.ToString();
            ...
            tdtra.rows[0].cells[1].valor = new Input { id = "txtIDHOJARUTA", visible = false, valor = (hojas.Count > 0) ? hojas[0].codigocabecera.Value.ToString() : "" }.ToString() + " " + new Input { id = "txtHOJARUTA", autocomplete = "GetHojaRutaObj", clase = Css.large, valor = (hojas.Count > 0) ? hojas[0].doctrancabecera : "", habilitado = habilitado }.ToString();
            ...
            tdtra1.rows[1].cells[1].valor = new Input { id = "txtSOCIO", clase = Css.large, habilitado = true, valor = (hojas.Count > 0) ? hojas[0].apellidosocio + " "+hojas[0].nombresocio: "" }.ToString() + new Input { id = "txtCODSOC", clase = Css.medium, valor = (hojas.Count > 0 && hojas[0].codigosocio != null) ? hojas[0].codigosocio.Value.ToString() : "", visible = false }.ToString();
            
            tdtra1.rows[2].cells[0].valor = "Chofer:";
            tdtra1.rows[2].cells[1].valor = new Input { id = "txtCHOFER", clase = Css.large, habilitado = true, valor = (hojas.Count > 0) ? hojas[0].apellidochofer + " " + hojas[0].nombrechofer : "" }.ToString() + new Input { id = "txtCODCHO", clase = Css.medium, valor = (hojas.Count > 0 && hojas[0].codigochofer != null) ? hojas[0].codigochofer.Value.ToString() : "", visible = false }.ToString();
        ...
        public static string GetFirst(string valor)
        {
            if (valor != null)
            {
        ...
        public static string GetCabeceraFromLGC(object objeto)
        {
            ...
            List<vPlanillaCliente> planillas = vPlanillaClienteBLL.GetAll(new WhereParams("cabecera.com_codigo={0}", comprobante.com_codigo), "detalle.com_numero");
            string nombressocio = "";
            if (planillas.Count > 0)
            {
                nombressocio = GetFirst(planillas[0].detalle_apellidos) + " " + GetFirst(planillas[0].detalle_nombres);
                foreach (vPlanillaCliente item in planillas)
                {
                    string noms = GetFirst(item.detalle_apellidos) + " " + GetFirst(item.detalle_nombres);
                    if (nombressocio != noms)
                    {
                        nombressocio = "";
                        break;
                    }
            ...
            if (arrayporcseguro.Length > 1)
            {
                if (comprobante.com_almacen.HasValue && comprobante.com_pventa.HasValue)
                {
                    for (int i = 1; i < arrayporcseguro.Length; i++)
                    {
                        string[] arrayvalores = arrayporcseguro[i].Split(';');

                        if (comprobante.com_almacen.Value.ToString() == arrayvalores[0] && comprobante.com_pventa.Value.ToString() == arrayvalores[1])
                        {
                            valorporcseguro = decimal.Parse(arrayvalores[2]);
                            break;
                        }
            ...
            //if (empresa.emp_id == "01900168077001")//SOLO PARA CARLOGISTICA
            //{
            Persona informante = PersonaBLL.GetByPK(new Persona { per_empresa = comprobante.com_empresa, per_empresa_key = comprobante.com_empresa, per_codigo = empresa.emp_informante.Value, per_codigo_key = empresa.emp_informante.Value });
            html.AppendLine("<div style='display:none'>");
            html.AppendLine(new Input { id = "txtNOMBRESREM", valor = informante.per_razon, visible = false }.ToString() + new Input { id = "txtCODREM", visible = false, valor = informante.per_codigo }.ToString() + new Input { id = "txtCIRUCREM", visible = false, valor = informante.per_ciruc }.ToString() + new Input { id = "txtTELEFONOREM", visible = false, valor = informante.per_telefono }.ToString() + " " + new Input { id = "txtDIRECCIONREM", visible = false, valor = informante.per_direccion }.ToString());
            html.AppendLine(new Input { id = "txtNOMBRESDES", visible = false, valor = persona.per_razon }.ToString() + new Input { id = "txtCODDES", visible = false, valor = persona.per_codigo }.ToString() + new Input { id = "txtCIRUCDES", visible = false, valor = persona.per_ciruc }.ToString() + new Input { id = "txtTELEFONODES", visible = false, valor = persona.per_telefono }.ToString() + " " + new Input { id = "txtDIRECCIONDES", visible = false, valor = persona.per_direccion }.ToString());
            html.AppendLine(new Input { id = "txtSOCIO", visible = false, valor = nombressocio }.ToString());

            decimal valordeclarado = 0;
            if (comprobante.total.tot_tseguro.HasValue)
                valordeclarado = (comprobante.total.tot_tseguro.Value * 100) / valorporcseguro;

            html.AppendLine(new Input { id = "txtVALORDECLARADO", valor = Formatos.CurrencyFormat(valordeclarado) }.ToString());
            html.AppendLine(new Input { id = "txtPORCSEGURO", valor = Formatos.CurrencyFormat(valorporcseguro) }.ToString());
        ...
        public static string GetDetalle(object objeto)
        {
            ...
            tdatos.AddColumn("Id", "width10", "", new Input() { id = "txtIDPRO", placeholder = "ID", autocomplete = "GetProductoObj", clase = Css.blocklevel }.ToString() + new Input() { id = "txtCODPRO", visible = false }.ToString() + new Input() { id = "txtCALCPRO", visible = false }.ToString()+ new Input() { id = "txtTOTPRO", visible = false }.ToString());
            ...
            foreach (Dcomdoc item in comprobante.ccomdoc.detalle)
            {
                ...
                row.data = "data-codpro=" + item.ddoc_producto + " data-calcpro=" + item.ddoc_productocalcula+ " data-totpro=" +item.ddoc_productototal;
                row.removable = true;
        ...
        public static string GetDetalleFromLGC(object objeto)
        {
            ...
            HtmlRow row = new HtmlRow();
            row.data = "data-codpro=" + pro.pro_codigo + " data-calcpro='' data-totpro=" + pro.pro_total;
            row.removable = true;
        ...
        public static string GetPie(object objeto)
        {
            ...
            if (comprobante.total.tot_vseguro.HasValue && comprobante.total.tot_porc_seguro.HasValue)
                valorseguro = comprobante.total.tot_vseguro.Value * (comprobante.total.tot_porc_seguro.Value / 100);
            else if (comprobante.total.tot_tseguro.HasValue)
                valorseguro = comprobante.total.tot_tseguro.Value;

            StringBuilder html = new StringBuilder();

            HtmlTable tdatos2 = new HtmlTable();
            tdatos2.CreteEmptyTable(3, 2);
            tdatos2.rows[0].cells[0].valor = "TOT. BULTOS:";
            tdatos2.rows[0].cells[1].valor = new Input { id = "txtTOTBULTOS", clase = Css.medium + Css.amount, habilitado = false, valor = Formatos.CurrencyFormat(totbultos) }.ToString();
            tdatos2.rows[1].cells[0].valor = "SEGURO:";
            tdatos2.rows[1].cells[1].valor = new Input { id = "txtSEGURO", clase = Css.medium + Css.amount, habilitado = false, valor = Formatos.CurrencyFormat(valorseguro) }.ToString();
            tdatos2.rows[2].cells[0].valor = "TRANSPORTE:";
            tdatos2.rows[2].cells[1].valor = new Input { id = "txtTRANSPORTE", clase = Css.medium + Css.amount, habilitado = false, valor = Formatos.CurrencyFormat(comprobante.total.tot_transporte) }.ToString();
            ...
            tdatos.rows[3].cells[1].valor = new Input { id = "txtDESCUENTO0", clase = Css.small + Css.amount, habilitado = false, numeric = true, valor = Formatos.CurrencyFormat(comprobante.total.tot_desc2_0) }.ToString();
            tdatos.rows[3].cells[2].valor = new Input { id = "txtDESCUENTOIVA", clase = Css.small + Css.amount, habilitado = false, numeric = true, valor = Formatos.CurrencyFormat(comprobante.total.tot_descuento2) }.ToString();
            html.AppendLine(tdatos.ToString());
            ...
            tdatos1.rows[0].cells[0].valor = "IVA " + valoriva.ToString() + "%:";
        ...
        public static string SaveObject(object objeto)
        {
            ...
            bool save = true;
            if (obj.com_token.HasValue)
            {
                save = General.UseToken(obj);
            }
            ...
            if (save)
            {
                ...
                try
                {
                    ...
                    General.UpdateTokenComprobante(obj);
        ...
        [WebMethod]
        public static string AddDestino(object objeto)
        {
            Destino des = new Destino(objeto);

            DestinoBLL.Insert(des);
            return "OK";
           
        }

        [WebMethod]
        public static string DelDestino(object objeto)
        {
            Destino des = new Destino(objeto);
            des.des_empresa_key = des.des_empresa;

            List<Destino> lst = DestinoBLL.GetAll("des_empresa=" + des.des_empresa + " and des_persona=" + des.des_persona + " and des_destino ='" + des.des_destino + "'", "");
            if (lst.Count > 0)
            {
                des = lst[0];
                des.des_empresa_key = des.des_empresa;
                des.des_codigo_key = des.des_codigo;

                DestinoBLL.Delete(des);
            }
        ...
        [WebMethod]
        public static string GetAgente(object objeto)
        {
            
            Persona obj = new Persona(objeto);
            obj.per_empresa_key = obj.per_empresa;
            obj.per_codigo_key = obj.per_codigo;
