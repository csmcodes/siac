...
namespace WebUI
{
    public partial class wfPlanillaClienteTC : System.Web.UI.Page
    {
        ...
        public static string GetDetalle(object objeto)
        {
            ...
            foreach (vPlanillaCliente item in lst)
            {
                ...
                row.cells.Add(new HtmlCell { valor = Formatos.CurrencyFormat(item.detalle_desc), clase = Css.right });
        ...
        public static string GetPie(object objeto)
        {
            ...
            tdatos2.CreteEmptyTable(5, 2);
            tdatos2.rows[0].cells[0].valor = "DESCUENTO:";
            tdatos2.rows[0].cells[1].valor = new Input { id = "txtDESCUENTO", clase = Css.small + Css.amount, habilitado = false, valor = Formatos.CurrencyFormat(comprobante.total.tot_desc1_0) }.ToString();
            tdatos2.rows[1].cells[0].valor = "SUBTOTAL 0:";
            tdatos2.rows[1].cells[1].valor = new Input { id = "txtSUBTOTAL0", clase = Css.small + Css.amount, habilitado = false, valor = Formatos.CurrencyFormat(comprobante.total.tot_subtot_0) }.ToString();
            tdatos2.rows[2].cells[0].valor = "SUBTOTAL IVA:";
            tdatos2.rows[2].cells[1].valor = new Input { id = "txtSUBTOTALIVA", clase = Css.small + Css.amount, habilitado = false, valor = Formatos.CurrencyFormat(comprobante.total.tot_subtotal) }.ToString();

            decimal valoriva = 12;//AQUI SE DEBE OBTENER EL VALOR DE IVA DESDE LA BD
            tdatos2.rows[3].cells[0].valor = "IVA " + valoriva + "%:";
            tdatos2.rows[3].cells[1].valor = new Input { id = "txtIVAPORCENTAJE", visible = false, valor = valoriva.ToString() }.ToString() + new Input { id = "txtIVA", clase = Css.medium + Css.amount, habilitado = false, valor = Formatos.CurrencyFormat(comprobante.total.tot_timpuesto) }.ToString();


            tdatos2.rows[4].cells[0].valor = "TOTAL:";
            tdatos2.rows[4].cells[1].valor = new Input { id = "txtTOTALCOM", clase = Css.medium + Css.totalamount, habilitado = false, valor = Formatos.CurrencyFormat(comprobante.total.tot_total) }.ToString();
        ...
        public static string UpdateComprobante(Comprobante obj)
        {
            ...
            objU.com_fecha = General.ResolveFechaComprobante(obj.com_fecha, true);
