...
namespace WebUI
{
    public partial class wfReporteCompraBienes : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[4].cells[1].valor = new Boton { click = "LoadReporte(0);return false;", valor = "Compras" }.ToString() + new Boton { click = "LoadReporte(1);return false;", valor = "Compras con retención" }.ToString() + new Boton { click = "LoadReporte(2);return false;", valor = "Compras sin retención" }.ToString();
