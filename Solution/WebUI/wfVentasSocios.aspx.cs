...
namespace WebUI
{
    public partial class wfVentasSocios : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[1].cells[1].valor = new Select { id = "cmbALMACEN", clase = Css.large, diccionario = Dictionaries.GetAlmacen(), withempty = true }.ToString();
            tdatos.rows[2].cells[0].valor = "Punto Venta";
            tdatos.rows[2].cells[1].valor = new Select { id = "cmbPVENTA", clase = Css.large, diccionario = Dictionaries.Empty(), withempty = true }.ToString();
            tdatos.rows[3].cells[0].valor = "Desde:";
            tdatos.rows[3].cells[1].valor = new Input { id = "txtDESDE", placeholder = "DESDE", clase = Css.small, datepicker = true }.ToString();
            tdatos.rows[4].cells[0].valor = "Hasta:";
            tdatos.rows[4].cells[1].valor = new Input { id = "txtHASTA", placeholder = "HASTA", clase = Css.small, datepicker = true }.ToString();
            ...
            tdatos.rows[6].cells[1].valor = new Boton { click = "LoadReporte();return false;", valor = "Generar" }.ToString();
