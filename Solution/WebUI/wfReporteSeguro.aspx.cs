...
namespace WebUI
{
    public partial class wfReporteSeguro : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[4].cells[0].valor = "Remitente:";
            tdatos.rows[4].cells[1].valor = new Input { id = "txtREMITENTE", clase = Css.large, autocomplete = "GetPersonaObj" }.ToString() + "" + new Input { id = "txtCODREM", visible = false }.ToString();
            tdatos.rows[5].cells[0].valor = "Destinatario:";
            tdatos.rows[5].cells[1].valor = new Input { id = "txtDESTINATARIO", clase = Css.large }.ToString();
