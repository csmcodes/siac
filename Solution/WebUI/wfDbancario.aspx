<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDbancario.aspx.cs" Inherits="WebUI.wfDbancario" %>
                ...
                <div id="area">
                          <div style = "display :none">
                                        ...
                                        <asp:TextBox ID="txttclipro" runat="server"></asp:TextBox>   
                                         ...
                                         <asp:TextBox ID="txtmodify" runat="server"></asp:TextBox>                                      
                                    </div>              
                    ...
                    <div id="comcabecera">     
                        ...
                        <div id ="comcab" class="stdform">                                                     
                         ...
                         <br />
                    <div id="comdetalle" class="detalleauto" >   
                        <div class="row-fluid">                        
                                <div class="span9">     
                                    <div id="comdetallecontent" class='stdform detalleauto'>                                                      
                                    </div>                                       
                                 </div><!--span6-->
                                 <div class="span3">     
