<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfEstadoCuentanew.aspx.cs" Inherits="WebUI.wfEstadoCuentanew" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Estadocuentanew.js"></script>
...
<body>
      <form id="form1" runat="server">
           ...
           <div class="pageicon"><span class="iconfa-tags"></span></div>
            <div class="pagetitle">
                <h5>Estado de Cuenta por Persona</h5>
