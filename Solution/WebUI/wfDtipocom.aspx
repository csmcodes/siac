<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDtipocom.aspx.cs" Inherits="WebUI.wfDtipocom" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Dtipocom.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de detalle Siglas</h5>
                <h1>Detalle Siglas</h1>
            </div>
        </div><!--pageheader-->
