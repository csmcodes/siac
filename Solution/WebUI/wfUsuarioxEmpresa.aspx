<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfUsuarioxEmpresa.aspx.cs" Inherits="WebUI.wfUsuarioEmpresa" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/UsuarioxEmpresa.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de Usarios  por Empresas</h5>
                <h1>Usuarios Empresa</h1>
            </div>
        </div><!--pageheader-->
