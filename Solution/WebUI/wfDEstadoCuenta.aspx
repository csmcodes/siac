<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDEstadoCuenta.aspx.cs" Inherits="WebUI.wfDEstadoCuenta" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/DEstadoCuenta.js"></script>    
            ...
            <div class="maincontentinner">
                 <div id="area">
                    ...
                    <div id="masterdetail" class="widgetbox pull-left">      
                        <h4 class="widgettitle"><span class="icon-th-list icon-white"></span>Paquete</h4>
                            ...
                            <div id="masterdetailcontent" class='stdform'>
                                ...
                                <div id="detalle">                                    
                                    <div class="headtitle">
                                        ...
                                        <h4 class="widgettitle"><span class="icon-th-list icon-white"></span>Usuarios Asignados&nbsp;</h4>
                                    </div>                                       
