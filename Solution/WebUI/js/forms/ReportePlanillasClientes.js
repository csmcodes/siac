...
var formname = "wfReportePlanillasClientes.aspx";
var menuoption = "ReportePlanillasClientes";
...
function LoadRep() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=PLANILLASCLIENTES&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=" + cli;
