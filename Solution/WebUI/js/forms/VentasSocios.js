...
var formname = "wfVentasSocios.aspx";
var menuoption = "wfVentasSocios";
...
function LoadReporte() {
    ...
    var usr = $("#cmbUSUARIO").val();
    var politica = $("#cmbPOLITICA").val();
    if (pventa == null)
        pventa = "";
   // var flete = GetCheckValue($("#chkFLETE"));
   // var politica = (flete) ? "4" : "";
    
    var stralmacen = $("#cmbALMACEN option:selected").text();
    var strpventa = $("#cmbPVENTA option:selected").text();


    var url = "./reports/wfReportPrint.aspx?report=VENTASO&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=" + politica;
...
function LoadReporteCaja() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=VENTASOCAJA&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes,scrolling=yes,scrollbars=yes";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}
