...
var formname = "wfReporteGuiaPlanilla.aspx";
var menuoption = "ReporteGuiaPlanilla";
...
function LoadReporte() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=GUIAPLANILLA&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=" + cli + "&parameter9=" + pol + "&parameter10=" + strpol;
