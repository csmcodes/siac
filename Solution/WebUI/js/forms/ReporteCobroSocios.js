...
var formname = "wfReporteCobroSocios.aspx";
var menuoption = "wfReporteCobroSocios";
...
function LoadReporte() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=COSO&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr;
