...
var formname = "wfReporteSocioHojas.aspx";
var menuoption = "VentasSociosHojas";
...
function LoadReporte() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=VENSOHOJ&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa + "&parameter9=" + ruta + "&parameter10=" + strruta;
...
function LoadReporteN() {
    ...
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=HRSOCIO&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa + "&parameter9=" + ruta + "&parameter10=" + strruta;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}
...
function LoadReporteTotales() {
    ...
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=VENSODH&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa + "&parameter9=" + ruta + "&parameter10=" + strruta;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}
...
function LoadReporteOrdenado() {
    ...
    var usr = usuariosigned["usr_id"];
    var url = "./reports/wfReportPrint.aspx?report=VENSODHORD&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + socio + "&parameter4=" + usr + "&parameter5=" + almacen + "&parameter6=" + pventa + "&parameter7=" + stralmacen + "&parameter8=" + strpventa + "&parameter9=" + ruta + "&parameter10=" + strruta;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}
