...
var formname = "wfVentasRetenciones.aspx";
var menuoption = "VentasRetenciones";
...
function LoadRep() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=VENTARETE&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr;
...
function LoadReporteConsolidado() {
    var desde = $("#txtDESDE").val(); //.datepicker("getDate");
    var hasta = $("#txtHASTA").val(); //.datepicker("getDate");
    var almacen = $("#cmbALMACEN").val();
    var pventa = $("#cmbPVENTA").val();
    ...
    var url = "./reports/wfReportPrint.aspx?report=VENTARETECON&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr;
    var feautures = "top=0,left=0,width='+(screen.availWidth)+',height ='+(screen.availHeight)+',toolbar=0 ,location=0,directories=0,status=0,menubar=0,resizable=yes,scrolling=yes,scrollbars=yes";
    window.open(url, "Reporte", feautures);
    //loadIframeReport(url);
}
