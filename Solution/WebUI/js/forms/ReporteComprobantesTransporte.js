...
var formname = "wfReporteComprobantesTransporte.aspx";
var menuoption = "ReporteComprobantesTransporte";
...
function SetForm() {
    ...
    // Select with Search    
    $(".chzn-select").chosen();
    $("#cmbALMACEN").on("change", ChangeAlmacen);  //Opción "Cerrar" del combo de opciones de la sección de edición    
    ChangeAlmacen();
...
function LoadReporte() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=COMPTRANS&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + ruta + "&parameter9=" + estado + "&parameter10=" + usr;
...
function LoadRutas() {
    ...
    obj["usuario"] = usuariosigned["usr_id"];
    var jsonText = JSON.stringify({ objeto: obj });
    CallServerMethods(formname + "/GetRutas", jsonText, 2);
}

function LoadRutasResult(data) {
    if (data != "") {
