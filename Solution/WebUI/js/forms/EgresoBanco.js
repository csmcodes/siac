...
var formname = "wfEgresoBanco.aspx";
var menuoption = "wfEgresoBanco";
...
function LoadReporte() {
    ...
    var url = "./reports/wfReportPrint.aspx?report=EGRESOBAN&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr;
