...
var formname = "wfReporteGuiasFacturas.aspx";
var menuoption = "ReporteGuiasFacturas";
...
function LoadReporte() {
    ...
    var soc = $("#cmbSOCIO").val();
    var tipo = $("#cmbTIPO").val();


    var url = "./reports/wfReportPrint.aspx?report=GUIASFACTURAS&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=" + cli + "&parameter9=" + pol + "&parameter10=" + strpol + " &parameter11=" + soc + "&parameter12=" + tipo;
