...
var formname = "wfPuntoVenta.aspx";
var menuoption = "PuntoVenta";
...
function LoadDetalle() {
    var obj = {};
    obj["pve_almacen"] = $("#cmbALMACEN").val();
...
function GetJSONObject() {
    var obj = {};
    obj["pve_almacen"] = $("#cmbALMACEN").val();
    obj["pve_almacen_key"] = $("#cmbALMACEN").val();
    obj["pve_empresa"] =parseInt(empresasigned["emp_codigo"]);
    obj["pve_empresa_key"] =parseInt(empresasigned["emp_codigo"]);
    obj["pve_secuencia"] = $("#cmbSECUENCIA").val();
    obj["pve_secuencia_key"] = $("#txtSECUENCIA_key").val();   
    obj["pve_id"] = $("#txtID").val(); 
    obj["pve_nombre"] = $("#txtNOMBRE").val();
    obj["pve_responsable"] = $("#txtRESPONSABLE").val();
    obj["pve_centro"] = $("#cmbCENTRO").val();
    obj["pve_autoimpresor"] = GetCheckValue($("#chkAUTOIMPRESOR"));
    obj["pve_estado"] = GetCheckValue($("#chkESTADO"));
    obj["pve_idalmacen"] = $("#cmbALMACEN option:selected").text();
...
function SetJSONObject(obj) {
     ...
     $("#cmbSECUENCIA").val(obj["pve_secuencia"]);
    $("#txtSECUENCIA_key").val(obj["pve_secuencia_key"] );    
     $("#txtID").val(obj["pve_id"]);
     $("#txtNOMBRE").val(obj["pve_nombre"]);
    $("#txtRESPONSABLE").val(obj["pve_responsable"]);
    $("#cmbCENTRO").val(obj["pve_centro"]);   
    $("#chkAUTOIMPRESOR").prop("checked", SetCheckValue(obj["pve_autoimpresor"]));
    $("#chkESTADO").prop("checked", SetCheckValue(obj["pve_estado"]));
...
function CleanForm() {
    ...
    $("#txtRESPONSABLE").val("");
    $("#cmbCENTRO").val("");
    $("#chkAUTOIMPRESOR").prop("checked", false);
