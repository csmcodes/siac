...
var formname = "wfReporteTpagos.aspx";
var menuoption = "ReporteTpagos";
...
function LoadReporte() {
    ...
    //if (pventa == null)
    //    pventa = "";
    var tpago = $("#cmbTipoPago").val();
    var stralmacen =   $("#cmbALMACEN option:selected").text();
    var strpventa =  $("#cmbPVENTA option:selected").text();
    var usr = usuariosigned["usr_id"];

    //var url = "./reports/wfReportPrint.aspx?report=VENRET&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=" + impuesto;
    var url = "./reports/wfReportPrint.aspx?report=RETP&empresa=" + parseInt(empresasigned["emp_codigo"]) + "&parameter1=" + desde + "&parameter2=" + hasta + "&parameter3=" + almacen + "&parameter4=" + pventa + "&parameter5=" + stralmacen + "&parameter6=" + strpventa + "&parameter7=" + usr + "&parameter8=" + tpago;
