...
namespace WebUI
{
    public partial class wfReporteVentasSocio : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[5].cells[1].valor = string.Format("{0} {1}", new Boton { click = "LoadReporte();return false;", valor = "Reporte Detallado" }.ToString(), new Boton { click = "LoadReporteSaldos();return false;", valor = "Reporte Detallado Saldos" }.ToString());
            tdatos.rows[6].cells[0].valor = ":";
            tdatos.rows[6].cells[1].valor = new Boton { click = "LoadReporteVehiculo();return false;", valor = "Reporte Vehiculo" }.ToString();
            tdatos.rows[7].cells[0].valor = ":";
            tdatos.rows[7].cells[1].valor = new Boton { click = "LoadReporteTotales();return false;", valor = "Reporte Total" }.ToString();
