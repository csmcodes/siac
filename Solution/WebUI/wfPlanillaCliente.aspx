<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfPlanillaCliente.aspx.cs" Inherits="WebUI.wfPlanillaCliente" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/PlanillaCliente.js"></script>
...
<body>
     ...
     <div class="maincontent">
            <div class="maincontentinner">                                              
               ...
               <div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade in" id="InitModal">
                    <div class="modal-header">
                        <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
                        <h3 id="H1">Comprobante</h3>
                    </div>
                    <div id="formmodal" class="modal-body" style ="width :80%;height:auto;">                        
                        Aqui va el form
                    </div>
                    <div class="modal-footer">
                        <button id="saveinit" data-dismiss="modal" class="btn btn-primary btn-rounded">Aceptar</button> 
                        <button data-dismiss="modal" class="btn">Cerrar</button>                        
                    </div>
                </div><!--#myModal-->
