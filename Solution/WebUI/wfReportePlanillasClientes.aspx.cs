...
namespace WebUI
{
    public partial class wfReportePlanillasClientes : System.Web.UI.Page
    {
        ...
        public static string GetFiltros(object objeto)
        {
            ...
            tdatos.rows[4].cells[1].valor = new Input { id = "txtCLIENTE", placeholder= "CI/RUC Nombres...", clase = Css.large}.ToString();
            ...
            tdatos.rows[5].cells[1].valor = new Boton { click = "LoadRep();return false;", valor = "Reporte" }.ToString();
