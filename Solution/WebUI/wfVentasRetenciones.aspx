<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfVentasRetenciones.aspx.cs" Inherits="WebUI.wfVentasRetenciones" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/ReporteVentasRetenciones.js"></script>
</head>
<body>
     ...
     <div class="maincontent">
            <div class="maincontentinner">                                              
               <div id="area">
                    ...
                    <h4>REPORTE VENTAS RETENCIONES</h4>
                    <br />
                     <div id="comcabecera">     
