<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDetalleCuenta.aspx.cs" Inherits="WebUI.wfDetalleCuenta" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/DetalleCuenta.js"></script>
</head>
<body>
      ...
      <div class="pageheader">
            <div class="searchbar">               
                <div id="barra">                    
                  ...
                  <!--      <li><div class="btn" id="print"><i class="iconfa-save"></i> &nbsp; Imprimir </div></li> -->                                               
                    </ul>
                    ...
                    <div class ="span8">   
                             <div id="Div2">
                                <ul class="list-nostyle list-inline">
                                   ...
                                   <li><div class="btn" id="addnew"><i class="iconfa-plus"></i> &nbsp; Nuevo</div></li>
                                  <!--  <li><div class="btn" id="remove"><i class="iconfa-remove"></i> &nbsp; Quitar</div></li>-->
                                 <!--    <li><div class="btn" id="modi"><i class="iconfa-remove"></i> &nbsp; Modificar</div></li>-->
