<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDlistaprecio.aspx.cs" Inherits="WebUI.wfDlistaprecio" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Dlistaprecio.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de detalle lista precios</h5>
                <h1>Detalle lista precios</h1>
            </div>
        </div><!--pageheader-->
