<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfCuentaTransacc.aspx.cs" Inherits="WebUI.wfCuentaTransacc" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/CuentaTransacc.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Cuentas Por Transaciones</h5>
                <h1>Cuentas Por Transaciones</h1>
            </div>
        </div><!--pageheader-->
                 ...
                 <div id="area">
                  <div style = "display :none">
                                        ...
                                        <asp:TextBox ID="txttclipro" runat="server"></asp:TextBox>     
                                         <asp:TextBox ID="txtcodmod" runat="server"></asp:TextBox>                                        
                                    </div>   
                    <div id="masterdetail" class="widgetbox pull-left">      
                        <h4 class="widgettitle"><span class="icon-th-list icon-white"></span>Modulo</h4>
                            ...
                            <div id="masterdetailcontent" class='stdform'>
                                ...
                                <div id="detalle">                                    
                                    <div class="headtitle">
                                        ...
                                        <h4 class="widgettitle"><span class="icon-th-list icon-white"></span>Trnasacciones&nbsp;</h4>
                                    </div>                                       
