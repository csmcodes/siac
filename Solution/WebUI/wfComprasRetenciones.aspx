<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfComprasRetenciones.aspx.cs" Inherits="WebUI.wfComprasRetenciones" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/forms/ComprasRetenciones.js"></script>
</head>
<body>
    ...
    <div class = "maincontentinner">
     ...
     <div id="area">
                    ...
                    <h4>REPORTE COMPRAS CON RETENCIONES</h4>
                    <br />
                     <div id="comcabecera">     
