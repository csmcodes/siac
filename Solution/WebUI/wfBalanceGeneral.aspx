<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfBalanceGeneral.aspx.cs" Inherits="WebUI.wfBalanceGeneral" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/BalanceGeneral.js"></script>
...
<body>
      ...
      <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-tags"></span></div>
            <div class="pagetitle">
                <h5>Balance Cuentas</h5>
                <h1>Detalle Balance Cuentas</h1>
            </div>
        </div><!--pageheader-->
