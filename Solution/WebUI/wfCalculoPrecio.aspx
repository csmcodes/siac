<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfCalculoPrecio.aspx.cs" Inherits="WebUI.wfCalculoPrecio" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/CalculoPrecio.js"></script>
...
<body>
      ...
      <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-tags"></span></div>
            <div class="pagetitle">
                <h5>Detalle de caracteristicas para calculo de precios</h5>
                <h1>Calculo Precios</h1>
            </div>
        </div><!--pageheader-->
