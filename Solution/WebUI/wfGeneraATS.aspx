<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfGeneraATS.aspx.cs" Inherits="WebUI.wfGeneraATS" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/GeneraATS.js"></script>
...
<body>
    ...
    <div class = "maincontentinner">
     ...
     <div id="area">
                    ...
                    <h4>GENERACIÓN XML ANEXO TRANSACCIONAL SIMPLIFICADO</h4>
                    <br />
                     <div id="comcabecera">     
                                                                                                 
                    </div> 
                    <div style="color:red;font-weight:bold;" runat="server" id="errores">
