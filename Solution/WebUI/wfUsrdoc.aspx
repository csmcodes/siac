<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfUsrdoc.aspx.cs" Inherits="WebUI.wfUsrdoc" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/forms/Usrdoc.js"></script>    
...
<body>
    ...
    <div class="pageheader">
           ...
           <div class="pageicon"><span class="iconfa-cogs"></span></div>
            <div class="pagetitle">
                <h5>Asignación de detalle tipo de com</h5>
                <h1>Detalle tipo de com</h1>
            </div>
        </div><!--pageheader-->
