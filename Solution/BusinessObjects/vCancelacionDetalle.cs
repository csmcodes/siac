...
{
    public class vCancelacionDetalle
    {
        ...
        public string razonagente{ get; set; }
        ...
        public vCancelacionDetalle(IDataReader reader)
        {
            ...
            this.agente = (reader["agente"] != DBNull.Value) ? (Int32?)reader["agente"] : null;
            //this.razonagente= (reader["razonagente"] != DBNull.Value) ? (string)reader["razonagente"] : null;
        ...
        public string GetSQLALL()
        {
            string sql = "SELECT " +
                         ...
                         "   dca_monto_pla, " +
                         "   dca_planilla, " +
                         "   pf.per_codigo as socio, "+
                         "   pf.per_id idsocio, "+
                         "   pf.per_nombres as nombressocio, "+
                         "   pf.per_apellidos as apellidossocio,	"+
                         ...
                         "   cd.cdoc_ced_ruc ruccliente, " +
                         "   cd.cdoc_nombre razoncliente, " +
                         //"   ag.per_razon razonagente, " +                         
                         "  f.com_agente agente," +
                        "   dfp_tipopago, " +
                        "   dfp_monto, " +
                        "   dfp_monto_ext, " +
                        ...
                        "  t.tot_descuento1, " +
                         ...
                         "   LEFT JOIN total t ON ddo_empresa = t.tot_empresa AND ddo_comprobante = t.tot_comprobante " +
                         ...
                         //"   LEFT JOIN persona cl ON f.com_empresa = cl.per_empresa AND f.com_codclipro  = cl.per_codigo " + // Se retiran pues afectan rendimiento ago 2020
                         //"   LEFT JOIN persona ag ON f.com_empresa = ag.per_empresa AND f.com_agente= ag.per_codigo " + // Se retiran pues afectan rendimiento ago 2020
        ...
        public List<vCancelacionDetalle> GetStruc()
        {
            return new List<vCancelacionDetalle>();
        }
